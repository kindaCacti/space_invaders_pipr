...
class Squid(ShootingEntity):
    def __init__(self, position: list, speed: list = Settings.enemy_speed, size: int = Settings.squid_size, image: str = Settings.squid_image, bullet_speed_coefficient: int = 1, states: int = 1, score: int = 40):
